...
export interface IFileBodyEditRouterProps {
  navComponents: NavComponent[];
}

export const FileBodyEditRouter: React.FC<IFileBodyEditRouterProps> = ({ navComponents }) => {
...
export default FileBodyEditRouter;
